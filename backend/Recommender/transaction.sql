drop database if exists transactiondata;
...
INSERT INTO transactions (num_tickets, user_id, username, date_time, artist, concert_name, price, hall_id, ticket_sale_date_time,description,image_path) VALUES
